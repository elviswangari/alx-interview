...
def makeChange(coins, total):
    """
    Calculate the minimum number of coins needed to make change for a given total amount.
    ...
    Returns:
        int: The minimum number of coins needed to achieve the target total. Returns -1 if not possible.
    """
    if total <= 0:
        return 0
